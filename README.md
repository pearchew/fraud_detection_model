...
4. **Model Training:** Trained a baseline Logistic Regression model, Random Forest Model, and XGBoost and LightGBM model

## 📊 Results
The models were evaluated primarily on their ability to catch actual fraud (Recall) on the unseen testing data. Then the best models were serialised and saved as joblib files for implementation elsewhere.
